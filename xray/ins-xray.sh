...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
wget -q -O /usr/bin/del-user "https://raw.githubusercontent.com/myridwan/vip/ipuk/xray/del-ws.sh" && chmod +x /usr/bin/del-ws
wget -q -O /usr/bin/cek-user "https://raw.githubusercontent.com/myridwan/vip/ipuk/xray/cek-ws.sh" && chmod +x /usr/bin/cek-ws
wget -q -O /usr/bin/renew-user "https://raw.githubusercontent.com/myridwan/vip/ipuk/xray/renew-ws.sh" && chmod +x /usr/bin/renew-ws
...
wget -q -O /usr/bin/ssgrpc-menu "https://raw.githubusercontent.com/myridwan/vip/ipuk/menu_all/ssgrpc-menu.sh" && chmod +x /usr/bin/ssgrpc-menu
wget -q -O /usr/bin/add-ssws "https://raw.githubusercontent.com/myridwan/vip/ipuk/xray/add-ssws.sh" && chmod +x /usr/bin/add-ssws
wget -q -O /usr/bin/del-ssws "https://raw.githubusercontent.com/myridwan/vip/ipuk/xray/del-ssws.sh" && chmod +x /usr/bin/del-ssws
wget -q -O /usr/bin/renew-ssws "https://raw.githubusercontent.com/myridwan/vip/ipuk/xray/renew-ssws.sh" && chmod +x /usr/bin/renew-ssws
sleep 1
