...
echo -e "[ ${green}INFO${NC} ] Updating l2tp ..."
    ...
    wget -q -O /usr/bin/add-pptp https://raw.githubusercontent.com/myridwan/vip/ipuk/ipsec/add-pptp.sh && chmod +x /usr/bin/add-pptp
    wget -q -O /usr/bin/del-pptp https://raw.githubusercontent.com/myridwan/vip/ipuk/ipsec/del-pptp.sh && chmod +x /usr/bin/del-pptp
    wget -q -O /usr/bin/renew-pptp https://raw.githubusercontent.com/myridwan/vip/ipuk/ipsec/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
    wget -q -O /usr/bin/renew-l2tp https://raw.githubusercontent.com/myridwan/vip/ipuk/ipsec/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
    wget -q -O /usr/bin/trial-pptp https://raw.githubusercontent.com/myridwan/vip/ipuk/ipsec/trial-pptp.sh && chmod +x /usr/bin/trial-pptp
    wget -q -O /usr/bin/trial-l2tp https://raw.githubusercontent.com/myridwan/vip/ipuk/ipsec/trial-l2tp.sh && chmod +x /usr/bin/trial-l2tp
echo -e "[ ${green}INFO${NC} ] Updating menu ..."
    ...
    wget -q -O /usr/bin/ipsec-menu "https://raw.githubusercontent.com/myridwan/vip/ipuk/menu_all/ipsec-menu.sh" && chmod +x /usr/bin/ipsec-menu
...
echo -e "[ ${green}INFO${NC} ] Updating extension ..."
    ...
    #Update Set-BR
    wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/logcleaner.sh" && chmod +x /usr/bin/cleaner
    wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/system/backup.sh" && chmod +x /usr/bin/backup
    wget -q -O /usr/bin/bckp "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/system/bckp.sh" && chmod +x /usr/bin/bckp
    wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/system/restore.sh" && chmod +x /usr/bin/restore
    wget -q -O /usr/bin/kernel-updt "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/system/kernel-updt.sh" && chmod +x /usr/bin/kernel-updt
    wget -q -O /usr/bin/ubuntu-kernel "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/system/ubuntu-kernel.sh" && chmod +x /usr/bin/ubuntu-kernel
    wget -q -O /usr/bin/ram "https://raw.githubusercontent.com/myridwan/vip/ipuk/dll/system/ram.py" && chmod +x /usr/bin/ram
